...
namespace Backend.Migrations
{
    ...
    [Migration("20240920190045_checking_dates")]
    partial class checking_dates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.DomainModel.CheckingTimes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.DomainModel.DTOs.PrayerTiming", b =>
                {
                    b.HasOne("Backend.DomainModel.DTOs.City", "City")
                        .WithMany()
